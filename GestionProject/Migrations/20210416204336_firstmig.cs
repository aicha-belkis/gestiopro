    ...
    public partial class firstmig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamMemberProject", x => new { x.TeamMemberId, x.ProjectId });
                    table.ForeignKey(
                        name: "FK_TeamMemberProject_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamMemberProject_TeamMembers_TeamMemberId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2301D884-221A-4E7D-B509-0113DCC043E1", "486f0f92-8ce6-4d3d-9a63-c3a2f4620c33", "Manager", "MANAGER" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "B22698B8-42A2-4115-9631-1C2D1E2AC5F7", 0, "ff2a2acb-6197-4a48-97a4-193c1cbdfebe", "admin@gestionprojet.com", true, "Master", "Admin", false, null, "ADMIN@GESTIONPROJET.COM", "MASTERADMIN", "AQAAAAEAACcQAAAAEDfSNFSZYDEK0cXWxMFB2SF8wpW9k7OCOLtOC+4FoYS5oa2BPuVh1Ga+oAAaKEOcxw==", "+212651728313", true, "Manager", "00000000-0000-0000-0000-000000000000", false, "masteradmin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamMemberProject_ProjectId",
